  ...
  const WEEKLY_PROGRAM = [
    ...
    },
    {
      ...
      main: [
        ...
        { ex: "Single-Leg RDL", detail: "3 x 8/side — hold a light dumbbell in the opposite hand; slow and controlled, builds knee stability" },
      ],
    ...
    },
    {
      ...
      note: "Run as 4 rounds of 40s work / 20s rest, or a straight AMRAP for 15–20 min. Phase 3+: swap step-ups for step-downs off the same bench, then broad & vertical jumps.",
      cooldown: ["Full-body stretch, 5 min", "Foam roll quads and IT band — foam roller station"],
    },
    {
    ...
    },
    {
      ...
      warmup: [],
      main: [
        { ex: "Easy walk", detail: "20–30 min — treadmill, outside, or the indoor track if the gym has one" },
        { ex: "Light full-body stretch + foam roll", detail: "stretching mats + foam roller station" },
      ],
